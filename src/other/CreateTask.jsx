...
const CreateTask = () => {
  ...
  return (
    <div className='bg-[#1e1e1e] p-6 rounded-xl shadow-md shadow-black/10 mt-6 w-full max-w-7xl mx-auto px-4 lg:px-8'>
      <h2 className='text-xl font-bold text-gray-100 mb-6 text-center'>Create New Task</h2>

      <form onSubmit={submitHandler} className='flex flex-wrap w-full justify-between gap-4'>
        ...
        <div className='w-full md:w-[48%]'>
          <div className='mb-4'>
            ...
            <input
              ...
              className='w-full px-4 py-2 rounded-lg border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all'
              type="text"
